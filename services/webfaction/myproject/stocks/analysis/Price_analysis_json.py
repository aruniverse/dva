...
class price_analysis:
    ...
    def __init__(self, data_string, start_date_str, end_date_str, output_json_name, verbose):

        self.verbose=verbose #print output or not
        self.output_json_name=output_json_name  #name for output json object

        self.create_df(data_string) #create dataframe from datafile
    ...
    def create_df(self, data_string):

        self.df_data=pd.read_json(data_string)
