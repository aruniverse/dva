...
export class ChartUtils {
 static initChart(
  ...
  static createLegend(svg:d3.Selection<null, unknown, null, undefined>,legendData:any[], width:number, height:number) {
    ...
    legendData.forEach(d => {
        if(d['isLine']) {
            ...
            var dataset : [number, number][] = [[20,yOffset],[30,yOffset]];
            svg.append("path")
            .datum(dataset)
